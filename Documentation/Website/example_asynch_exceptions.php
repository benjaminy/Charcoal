<html>
<head>
<title>Asynchronous Exceptions Example</title>
...
of is <a href="http://dl.acm.org/citation.cfm?id=378858">Haskell</a>
(<a href="http://community.haskell.org/~simonmar/papers/async.pdf">authors'
copy</a>).</p>
...
receiver activity evaluates.  This pattern seems a little better-suited
to activities than conventional cooperative threads because yields
generally happen quite frequently, so there is a better chance of the
exception being delivered in a timely manner.</p>
