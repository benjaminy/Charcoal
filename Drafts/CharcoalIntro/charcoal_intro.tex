...
In this section we describe the problems that established multitasking primitives have with respect to the atomic or interruptible question.

\begin{figure}
\caption{}
\label{fig:trivial_call}
\end{figure}

\subsection{The Importance of Atoms and Interrupts}
...
If \texttt{otherProcedure} is interruptable, the program's global state can change as a result of actions taken by some concurrent task.
