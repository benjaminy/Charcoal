...
Parse the JSON file from a chrome performance analyzer profile into a Python datastructure with the following layout:
    ...
    "2435" :
        {
        "774": { "M":[metaevents], "Dx":[durationevents], "X":[completeevents], "I":[instantevents],...} ,
        "776": { "M":[metaevents], "Dx":[durationevents], [...], [...]},
        "675": { "M":[metaevents], "Dx":[durationevents], [...], [...]},
        ...
        }

    "5425" :
        {
        "345": { "M":[metaevents], "Dx":[durationevents], [...], [...]} ,
        "745": { "M":[metaevents], "Dx":[durationevents], [...], [...]},
        "623": { "M":[metaevents], "Dx":[durationevents], [...], [...]}, ......
        ...
        }
        ......
    }
...
def parseprofile(profile):
    ...
    events = get_durationevents(profile) + profile
    ...
    for event in events:
        ...
        if( eventtype == "E"):
            if stack:
                ...
                duration = long(event["ts"]) - long(durationevent["ts"])
                durationevent["dur"] = long(duration)
